...
public:
    WLSGradient(const GridBlock<T, ExecSpace, Layout> &block) {
        ...
        typename Ibis::RaggedArray<T, Layout, ExecSpace>::ArrayType w1(
            "weights", num_connections);
        typename Ibis::RaggedArray<T, Layout, ExecSpace>::ArrayType w2(
            "weights", num_connections);
        typename Ibis::RaggedArray<T, Layout, ExecSpace>::ArrayType w3(
            "weights", num_connections);
