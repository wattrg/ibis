...
public:
    ...
    template <typename layout = Ibis::DefaultArrayLayout,
              typename space = Ibis::DefaultMemSpace>
    ...
    template <typename exec = Ibis::DefaultExecSpace,
              typename layout = Ibis::DefaultArrayLayout>
