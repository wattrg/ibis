...
gmsh.model.geo.addPoint(length, -dy, 0.0) # 3
gmsh.model.geo.addPoint(length, height, 0.0) # 4
gmsh.model.geo.addPoint(0.0, height, 0.0) # 5
...
# boundaries
gmsh.model.addPhysicalGroup(1, [1,2], name="wall")
gmsh.model.addPhysicalGroup(1, [3, 4], name="outflow")
gmsh.model.addPhysicalGroup(1, [5], name="inflow") 
