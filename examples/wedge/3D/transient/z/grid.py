...
b00 = gmsh.model.geo.add_point(0.0, 0.0, inflow_length, grid_size)
c00 = gmsh.model.geo.add_point(0.0, ramp_height, inflow_length+ramp_length,
                               grid_size)
a10 = gmsh.model.geo.add_point(0.0, inflow_height, 0.0, grid_size)
b10 = gmsh.model.geo.add_point(0.0, inflow_height, inflow_length, grid_size)
c10 = gmsh.model.geo.add_point(0.0,
                               ramp_height+outflow_height,
                               inflow_length+ramp_length, grid_size)
...
# volumes
volume = gmsh.model.geo.extrude([(2, surface)], depth, 0, 0)
