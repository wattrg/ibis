...
# capsule points
a = gmsh.model.geo.add_point(0.0, 0.0, 0.0, size)
...
c = gmsh.model.geo.add_point(4.46939, 0.0, 0.0)
...
ov = gmsh.model.geo.revolve([(2, ps)], 0, 0, 0, 1, 0, 0, 2 * math.pi / 3, [7], recombine=True)
ov = gmsh.model.geo.revolve([(2, 40)], 0, 0, 0, 1, 0, 0, 2 * math.pi / 3, [7], recombine=True)
ov = gmsh.model.geo.revolve([(2, 72)], 0, 0, 0, 1, 0, 0, 2 * math.pi / 3, [7], recombine=True)
